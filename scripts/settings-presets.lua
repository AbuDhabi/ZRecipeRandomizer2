...
local presets = {
    ["DEFAULT"] = {
        ...
        forbidden_recipes = "",
        forbidden_ingredients = "[item=empty-barrel]",
        forbidden_results = "[item=empty-barrel]",
