...
local presets = {
	...
	["space-age"] = {
		default_values = "(:[item=coal][item=stone][item=iron-ore][item=copper-ore]:1) ([item=electric-mining-drill][fluid=sulfuric-acid]:[item=uranium-ore]:3) (:[fluid=water]:0.0002) ([item=boiler]:[fluid=steam]:0.0002) ([item=pumpjack]:[fluid=crude-oil]:0.4) ([item=asteroid-collector]:[item=metallic-asteroid-chunk][item=carbonic-asteroid-chunk][item=oxide-asteroid-chunk]:10) ([item=thruster]:[item=yumako][item=jellynut]:3) ([item=thruster]:[item=spoilage]:1) ([item=thruster]:[item=iron-bacteria][item=copper-bacteria]:5) ([item=thruster]:[item=pentapod-egg]:30) ([item=thruster]:[item=tungsten-ore]:6) ([item=thruster]:[item=calcite]:1) ([item=thruster]:[item=scrap]:1) ([item=recycler]:[item=holmium-ore]:5) ([item=capture-robot-rocket]:[item=biter-egg]:10) ([item=agricultural-science-pack]:[item=raw-fish][item=wood]:5) ([item=electromagnetic-science-pack][item=metallurgic-science-pack][item=agricultural-science-pack]:[fluid=lithium-brine][fluid=fluorine]:0.2) ([item=electromagnetic-science-pack][item=metallurgic-science-pack][item=agricultural-science-pack]:[fluid=ammoniacal-solution]:0.02) ([item=railgun-turret]:[item=promethium-asteroid-chunk]:20)",
        ...
        not_random_recipes = "[recipe=nuclear-fuel-reprocessing] [recipe=fluoroketone-cooling] [recipe=acid-neutralisation] [recipe=steam-condensation] [recipe=ice-melting] [recipe=coal-synthesis] [recipe=wood-processing] [recipe=fish-breeding] [recipe=copper-bacteria-cultivation] [recipe=iron-bacteria-cultivation] [recipe=small-electric-pole]",
        not_random_resources = "[item=wood] [item=raw-fish]",
